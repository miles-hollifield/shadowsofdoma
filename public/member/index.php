      ...
      <div id="index-section">
          ...
          <div id="index-item-1" class="index-item-container">
            <div class="index-item background">
              <div class="item-img">
                <a href="<?php echo url_for('/member/about.php'); ?>"><img id="img1" class="responsive" src="<?php echo url_for('/img/ff14-fc-desk-small.png'); ?>" alt="Free Company Desk" width="360" height="202"></a>
              </div>
              ...
              <div class="learn">
                <a class="button-style button-link-style" href="<?php echo url_for('/member/about.php'); ?>">Learn More</a>
              </div>
            </div>
          </div>
          ...
          <div id="index-item-2" class="index-item-container">
            <div class="index-item background">
              ...
              <div class="learn">
                <a class="button-style button-link-style" href="<?php echo url_for('/member/staff.php'); ?>">Learn More</a>
              </div>
            </div>
          </div>
          ...
          <div id="index-item-3" class="index-item-container">
            <div class="index-item background">
              ...
              <div class="learn">
                <a class="button-style button-link-style" href="<?php echo url_for('/member/roster.php'); ?>">Learn More</a>
              </div>
            </div>
          </div>
        ...
        <div id="index-item-1" class="index-item-container-mobile">
            <div class="index-item background">
              ...
              <p>Shadows of Doma is a Free Company (guild) in the MMORPG game Final Fantasy XIV on Sargatanas server! Shadows of Doma is a social FC for the friendly and considerate, those looking to expand their...</p>
              <div class="learn">
                <a class="button-style" href="<?php echo url_for('/member/about.php'); ?>">Learn More</a>
              </div>
            </div>
          </div>
          ...
          <div id="index-item-2" class="index-item-container-mobile">
            <div class="index-item background">
              ...
              <p>Questions, comments, or concerns? Our Leadership Team is here to help! Be it big or small, our Council and Officer members are here to make sure you have the best experience possible during your..</p>
              <div class="learn">
                <a class="button-style" href="<?php echo url_for('/member/staff.php'); ?>">Learn More</a>
              </div>
            </div>
          </div>
          ...
          <div id="index-item-3" class="index-item-container-mobile">
            <div class="index-item background">
              ...
              <div class="learn">
                <a class="button-style" href="<?php echo url_for('/member/roster.php'); ?>">Learn More</a>
              </div>
            </div>
          </div>        

...
?>
      ...
      <div id="main">
        ...
        <!-- Thumbnail Gallery -->
        <div id="gallery-grid">
          <img src="<?php echo url_for('/img/gallery/ff14-group-photo-small.jpg'); ?>" alt="Free Company Group Photo" width="345" height="194">
          <img src="<?php echo url_for('/img/gallery/ff14-shadowbringers-small.jpg'); ?>" alt="Free Company Dungeon" width="345" height="194">
          <img src="<?php echo url_for('/img/gallery/ff14-rival-wings-small.jpg'); ?>" alt="Free Company Fight" width="345" height="194">
          <img src="<?php echo url_for('/img/gallery/ff14-all-black-small.jpg'); ?>" alt="Free Company All Black Photo" width="345" height="194">
        </div>
